...
class TemplateSearchToPlaceOrderAndCancel extends BaseTemplate {
  ...
  val scn = scenario(name)
    ...
    .exec(productInformation())
    .exitHereIfFailed
    .exec(productDescription())
    .exitHereIfFailed
    .exec(addToCart())
    .exitHereIfFailed
    .exec(recommendedOTCProducts())
    .exitHereIfFailed
    .exec(savingsOnCart())
    .exitHereIfFailed
    .exec(sendOTP())
    ...
    .exec(login())
    .exitHereIfFailed
    .exec(cartSyncAfterLogin())
    .exitHereIfFailed
    .pause(2 seconds)
    .exec(cartItemsCountAfterLogin())
    .exitHereIfFailed
    .exec(fetchAddressOrAddIfNotExist())
    .exitHereIfFailed
    .exec(estimateDelivery())
    .exitHereIfFailed
    .exec(deliveryPreference())
    .exitHereIfFailed
    .exec(paymentInstrumentationBeforeOrderPlacement())
    .exitHereIfFailed
    .exec(cartItems())
    .exitHereIfFailed
