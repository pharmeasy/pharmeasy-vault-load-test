...
object B2BOrderProcessingActions extends BaseActions {
  ...
  //  def signInToPickerApp(thea: String ) = {
  //    var pickerData = scala.collection.mutable.Map.empty[String, String]
  //        val payload: JWTAuthHeaderPayload = TokenGeneration.getPickerDefaultAuthPayload(thea);
  //
  //    pickerData("pickerId") = payload.getUid
  //    pickerData("pickerAppToken") = TokenGeneration.generateToken(payload)
  //    pickerData
  //  }
